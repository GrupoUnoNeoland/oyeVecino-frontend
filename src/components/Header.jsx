  ...
  return (
    ...
    <div id="header-container">
      ...
      {!user && (
        <>
          <NavLink to="/register">
            <div className="header-nav__item--mobile" onClick={handleClickMenu}>REGISTER</div>
          </NavLink>
          <NavLink to="/login">
            <div className="header-nav__item--mobile" onClick={handleClickMenu}>LOGIN</div>
          </NavLink>
          </>
      )}
          {user && (
            <>
            <NavLink to="/profile">
              <div className="header-nav__item--mobile" onClick={handleClickMenu}>PROFILE</div>
            </NavLink>
          <NavLink to="/login">
            <div className="header-nav__item--mobile" onClick={handleClickMenu}>LOGOUT</div>
          </NavLink>
        </>
          )}
      </nav>
